...
{{
  ...
  "Things_to_Search": ["List of Topics relevant to the project to be created."],
...
```json
{
    ...
    "Things_to_Search": ["Fraud detection using machine learning","velocity check"],
...
```json
{
    ...
    "Security considerations": "",
    "Things_to_Search": ["List of Topics needed to be reserach for the required prompt."],
    "Story": ""
}
```
