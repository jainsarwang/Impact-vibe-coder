...
4. When a directory structure is generated by `directory_generator`.
...
3. After `directory_generator` call `version_resolver`  
4. After `version_resolver` call `code_planner`
