...
const SuperAdminLogin = ({ onLogin }: SuperAdminLoginProps) => {
  ...
  const handleLogin = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setError(err instanceof Error ? err.message : 'Authentication failed. Please check your credentials and ensure the backend is running.');
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-100 flex items-center justify-center p-4 relative overflow-hidden">
      ...
      <div className="w-full max-w-md relative z-10">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-xl text-gray-600 font-medium">Super Admin Portal</p>
        ...
        <Card className="shadow-2xl border-0 bg-white/95 backdrop-blur-sm relative overflow-hidden">
          ...
          <CardHeader className="space-y-1 pb-8 pt-8 relative z-10">
            <CardTitle className="text-3xl font-bold text-center text-gray-900 mb-2">Welcome Back</CardTitle>
            <p className="text-center text-gray-600 text-lg">Sign in to access the Super Admin Dashboard</p>
          </CardHeader>
                  ...
                  {isLoading ? (
                    <div className="flex items-center justify-center">
                      <div className="relative mr-3">
                        ...
                        <div className="absolute inset-0 w-5 h-5 border-2 border-transparent border-t-blue-200 rounded-full animate-spin" style={{ animationDirection: 'reverse', animationDuration: '1.5s' }}></div>
                      </div>
                      Signing in...
                    </div>
                  ) : (
