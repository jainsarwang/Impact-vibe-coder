...
const OrganizationHeader = ({ organization, onBack }: OrganizationHeaderProps) => {
    ...
    <header className="bg-white shadow-sm border-b">
      <div className="max-w-7xl mx-auto px-6 py-4">
        <div className="flex items-center space-x-4">
          <Button variant="outline" onClick={onBack} className="hover:bg-gray-50 text-sm h-8 px-3">
          ...
          <div className="flex items-center space-x-3">
            ...
            <div>
              <div className="flex items-center space-x-2">
                <h1 className="text-xl font-bold text-gray-900">{organization.organization_name}</h1>
                <Badge 
                  variant={isActive ? "default" : "secondary"} 
                  className={`${isActive ? "bg-emerald-500" : "bg-gray-400"} text-xs`}
                >
